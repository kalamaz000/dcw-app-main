            ...
            <div className={styles.container}>
                <Grid container spacing={2} justify="center">
                    <Grid item component={Card} xs={12} md={3} className={cx(styles.card, styles.infected)}>
                        <CardContent>
                            <Typography variant = "h5" color = "textPrimary" gutterBottom>Infectados 2.2</Typography>
                    ...
                    <Grid item component={Card} xs={12} md={3} className={cx(styles.card, styles.recovered)}>
                        <CardContent>
                            <Typography variant = "h5" color = "textPrimary" gutterBottom>Recuperados 2.2</Typography>
                            <Typography variant = "h5">
                    ...
                    <Grid item component={Card} xs={12} md={3} className={cx(styles.card, styles.deaths)}>
                        <CardContent>
                            <Typography variant = "h5" color = "secondary" gutterBottom> Mortes 2.2</Typography>
                            <Typography variant = "h5">
